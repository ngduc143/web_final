...
class PlacementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create placement" do
    assert_difference("Placement.count") do
      post placements_url, params: { placement: { cosmetic_id: @placement.cosmetic_id, floor: @placement.floor, product_shelf: @placement.product_shelf } }
    end
  ...
  test "should update placement" do
    patch placement_url(@placement), params: { placement: { cosmetic_id: @placement.cosmetic_id, floor: @placement.floor, product_shelf: @placement.product_shelf } }
